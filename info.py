...
API_ID = int(environ.get('27335730'))
API_HASH = environ.get('ae5a5f660ffdf3e08997d493c32932f5')
BOT_TOKEN = environ.get('6110043034:AAEi_w1qbyaXEbNVJIaGpkyTsk8h_58Bz6I')
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1735392935').split()]
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION",'join @Mask_kp_2k_movies')
